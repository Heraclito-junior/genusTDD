...
public class TelaListaClientes extends javax.swing.JFrame {
    ...
    public TelaListaClientes(int idFuncionario) {
        funcoes = new Funcoes();
    ...
    private void initComponents() {
        ...
        labelVenda.setText("Lista de clientes");
        ...
        ArrayList<String> clientes = funcoes.listarClientes();
        int tamanho = clientes.size();

        for (int i = 0; i < tamanho; i++) {
            auxiliarTuplas = clientes.get(i).split(Pattern.quote("_-*7"));
            for (int j = 0; j < 2; j++) {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaListaClientes(idFuncionario).setVisible(true);
            }
        });
    }
